<template>
    <div class="now-playing-widget">
        <div class="now-playing-widget__container">
            ...
            <div class="now-playing-widget__icon"><a @click="$parent.$emit('toggle-albums')" :href="track.url" target="_blank" class="now-playing-widget__link now-playing-widget__link--black"><i class="fab fa-lastfm"></i></a></div>
        </div>
    </div>          
</template>
