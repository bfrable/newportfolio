<template>
    <div class="now-playing-widget">
        <div class="now-playing-widget__container">
            ...
            <div @click="$parent.$parent.$emit('toggle-albums') && toggleAlbumsOpen() && setHeight()" v-bind:class="glow"><a target="_blank" class="now-playing-widget__link now-playing-widget__link--black"><i v-if="!this.albumsOpen" class="fab fa-lastfm"></i><i v-if="this.albumsOpen" class="fab fa-close"></i></a></div>
        </div>
    </div>          
</template>
