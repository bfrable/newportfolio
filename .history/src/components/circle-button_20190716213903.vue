<template>
    <div @click="$parent.$parent.$emit('toggle-albums') && toggleAlbumsOpen()" v-bind:class="glow">
        <a target="_blank" class="now-playing-widget__link now-playing-widget__link--black">
