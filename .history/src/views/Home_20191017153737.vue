    ...
    <main class="main-content">
      ...
      <div class="main-content__column">
        <h2 class="main-content__intro">
          Hello! I’m Brett Frable. I specialize in front-end development and UX/UI design. I'm
         currently employed at <a href="" class="link">Duke Energy</a> as a Front End Developer.
         </h2>
        <div class="projects">
